...
$opt_name = 'portal_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Первый блок', 'umra' ),
		'id'               => 'globalsetings5',
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Что вы должны знать', 'umra' ),
		'id'               => 'home_header14',
		'subsection'       => true,
		...
		'fields'           => array(
			...
			array(
				'id'       => 'title_video14',
				'type'     => 'text',
				'title'    => esc_html__( 'Заголовок', 'umra' ),
				'default'  => '',
			),
			array(
				'id'       => 'popup_video14',
				'type'     => 'text',
				'title'    => esc_html__( 'Ссылка', 'umra' ),
				'default'  => '',
			),
			array(
				'id'       => 'popup_video140',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Описание', 'umra' ),
				'default'  => '',
			),
		)
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Что такое строительный контроль', 'umra' ),
		'id'               => 'globalsetings',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)	
...
//Что такое строительный контроль  Что такое строительный контроль Что такое строительный контроль
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль', 'umra' ),
		'id'               => 'home_header',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
		'fields'           => array(
			array(
				'id'           => 'home_video1',
				'type'         => 'media',
				'url'          => true,
				'title'        => esc_html__( 'Фоновая картинка', 'umra' ),
				'compiler'     => 'true',
				'desc'         => esc_html__( 'Фоновое изображение', 'umra' ),
				'subtitle'     => esc_html__( 'Вставьте кратинку', 'umra' ),
				'preview_size' => 'full',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль1', 'umra' ),
		'id'               => 'home_header1',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль2', 'umra' ),
		'id'               => 'home_header2',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль3', 'umra' ),
		'id'               => 'home_header3',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль4', 'umra' ),
		'id'               => 'home_header4',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Строительный контроль5', 'umra' ),
		'id'               => 'home_header5',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
// Виды строительного контроля Виды строительного контроля Виды строительного контроля

Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды контроля', 'umra' ),
		'id'               => 'globalsetings1',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)	
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля', 'umra' ),
		'id'               => 'home_header6',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля1', 'umra' ),
		'id'               => 'home_header7',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля2', 'umra' ),
		'id'               => 'home_header8',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля3', 'umra' ),
		'id'               => 'home_header9',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля4', 'umra' ),
		'id'               => 'home_header10',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Виды строительного контроля5', 'umra' ),
		'id'               => 'home_header11',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Риски контроля', 'umra' ),
		'id'               => 'globalsetings2',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)	
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Риски строительного контроля', 'umra' ),
		'id'               => 'home_header12',
		'subsection'       => true,
		'customizer_width' => '450px',
		'desc'             => esc_html__( 'Главная страница' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Наша Миссия', 'umra' ),
		'id'               => 'globalsetings3',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
...
Redux::set_section(
	...
	array(
		...
		'fields'           => array(
			...
			array(
				'id'       => 'title_video_text13',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Текст', 'umra' ),
				'default'  => '',
			),
			array(
				'id'       => 'title_video_text113',
				'type'     => 'textarea',
				'title'    => esc_html__( 'Текст', 'umra' ),
				'default'  => '',
			),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Фоновая картинка на странице записи', 'umra' ),
		'id'               => 'globalsetings05',
		'customizer_width' => '400px',
		'icon'             => 'el el-cogs',
	)	
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Изображение', 'umra' ),
		'id'               => 'home_header102',
		'subsection'       => true,
		'customizer_width' => '450px',
		'fields'           => array(
